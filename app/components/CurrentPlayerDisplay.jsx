...
export default function CurrentPlayerDisplay({ player, color, handleChance, alert, setAlert }) {
    ...
    return (
        <div className={`absolute sm:top-18 sm:right-6 sm:w-sm flex flex-col items-center border border-gray-500 sm:rounded-2xl sm:py-8 sm:pb-22  w-68 py-4 pb-8 top-4 rounded-xl`}>
